...
import { Building2, Pencil, CalendarDays, Maximize } from "lucide-react";
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    {asset.type === 'real_estate' && (
                        <>
                            {/* Fake Mortgage Block for structural demo */}
                            <PremiumCard className="border-rose-100 ring-4 ring-rose-50 p-6">
                                <div className="flex justify-between items-center mb-6">
                                    <h3 className="text-slate-900 font-bold text-lg">{t("asset_detail.active_mortgage")}</h3>
                                ...
                                <div className="flex justify-between items-end mb-4">
                                    <div>
                                        ...
                                        <p className="text-rose-500 font-medium text-xs">Principal Remaining</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-sm font-bold text-slate-900">3.2%</p>
                                ...
                                <div className="bg-white rounded-lg p-3 border border-slate-100 mb-4 flex justify-between items-center shadow-sm">
                                    ...
                                    <span className="font-mono font-bold text-slate-900">$1,850</span>
                                </div>
